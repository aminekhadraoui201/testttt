...
import { TestBackContentComponent } from './test-back-content/test-back-content.component';
import { TestFrontComponent } from './test-front/test-front.component';
import { TestFrontContentComponent } from './test-front-content/test-front-content.component';
...
@NgModule({
  declarations: [
    ...
    TestBackComponent,
    TestBackContentComponent,
    TestFrontComponent,
    TestFrontContentComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
